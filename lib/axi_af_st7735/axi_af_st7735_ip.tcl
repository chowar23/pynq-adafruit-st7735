...
add_files -norecurse -fileset sources_1 "axi_af_st7735.vhd"
add_files -norecurse -fileset sources_1 "axi_lite_register_interface.vhd"
add_files -norecurse -fileset sources_1 "spi_controller.vhd"
add_files -norecurse -fileset sources_1 "../common/nand_compute_std.vhd"
...
ipx::associate_bus_interfaces -busif s_axi_lite -clock axi_aclk [ipx::current_core]
